...
namespace Extensions
{
	public static class StringExt
	{
		...
		public static int GetNumericPart(this string str)
		{
			string numericPart = "";
			...
			int.TryParse(numericPart, out int numeric);

			return numeric;
		}

		public static int GetASCIIValue(this string str)
		{
			int totalASCII = 0;
		...
		public static int[] GetRemoteLevelOrder(this string remoteLevelKey)
		{
			string[] trimmedLevels = remoteLevelKey.Split("-".ToCharArray());

			List<int> temp = new List<int>();

			trimmedLevels.ForEach(x => temp.Add(int.Parse(x)));
		...
		public static string ReplaceAt(this string str, int index, int count, string replace)
		{
			return str.Remove(index, UnityEngine.Mathf.Min(count, str.Length - index))
