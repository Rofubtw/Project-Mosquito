...
namespace Extensions
{
	public static class IListExt
	{
		...
		public static IList<T> GetAll<T>(this IList<T> self, Predicate<T> predicate)
		{
			var result = new List<T>();
		...
		public static bool Contains<T>(this IList<T> self, Predicate<T> match)
		{
			if (self == null)
				return false;
		...
		public static void RemoveRange<T>(this List<T> myList, List<T> removeObjects) => myList.RemoveAll(a => removeObjects.Contains(a));
		...
		public static bool IsDefinedAt<T>(IList<T> self, int index) => index < self.Count;
	}
}