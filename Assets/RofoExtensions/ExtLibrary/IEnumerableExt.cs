...
namespace Extensions
{
	public static class IEnumerableExt
	{
		...
		public static T RandomAtExcept<T>(this IEnumerable<T> self, IEnumerable<T> except)
		{
			UnityEngine.Random.InitState((int)(Guid.NewGuid().GetHashCode()));

			var notExcluded = self.Except(except);

			return notExcluded.Any()
				? notExcluded.ElementAt(UnityEngine.Random.Range(0, notExcluded.Count()))
				: default;
		}
